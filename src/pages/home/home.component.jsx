...
const Me = () => {
  ...
  return <>
    ...
    <Grid container spacing={0} mt={50} justifyContent="center">

      <Grid item xs={12} sm={10} md={7}  border={1}>
        <Box>
          <CardMedia
      ...
      <Grid item xs={12} sm={10} md={5}  border={1} component="div">
      ...
      <Grid item xs={12} sm={10} md={6} border={1}>
      ...
      <Grid  m={0} item xs={12} md={6} border={1}>
      ...
      <Grid  m={0} item xs={12} md={8} border={1}>
        <Box>
          <img className="info" src={infoapi} alt="" />
        </Box>
      </Grid>

      <Grid  m={0} item xs={12} md={4} border={1}>
      <Box className="boxi roti-2">
